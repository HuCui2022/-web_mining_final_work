...
# create model
model = create_model(num_classes=21)   #需要类别数量进行改变。

# load train weights
train_weights = "./save_weights/resNetFpn-model-3.pth"
# train_weights = "./save_hand_weights/resNetFpn-model-4.pth"
...
original_img = Image.open("./test.jpg")#手势测试图片。
