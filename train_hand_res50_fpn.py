...
import os
from my_dataset import HandDatset
...
def main(parser_data):
    ...
    for epoch in range(parser_data.start_epoch, parser_data.epochs):
        ...
        save_files = {
            ...
            'epoch': epoch}
        torch.save(save_files, "./save_hand_weights/resNetFpn-model-{}.pth".format(epoch))
...
if __name__ == "__main__":
    ...
    # 文件保存地址
    parser.add_argument('--output-dir', default='./save_hand_weights', help='path where to save')
